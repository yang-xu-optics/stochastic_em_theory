...
- State applications: HHG in gas, THz optical rectification, and THz plasma
  emission.

## 1. Introduction

- Squeezed vacuum and bright squeezed vacuum as structured quantum light.
- Why nonlinear strong-field and THz emission are interesting testbeds.
